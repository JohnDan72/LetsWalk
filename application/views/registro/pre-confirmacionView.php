...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class=" d-flex justify-content-center">
            <img src="<?= base_url() ?>private/media/icons/si.svg" alt="" width="200px" class="mt-5">
        </div>

        <h2 class="display-4 text-center mt-4">¡Perfecto!</h2>
        <h4 class="text-center mt-3">Por favor confirma tu dirección de correo</h4>
        <p class="text-center mt-5 mb-5">Si has llegado hasta aquí, ¡Felicidades!. Al parecer todo ha 
            salido bien, en cualquier momento recibirás un correo. Nos vemos en un rato para concluir 
            tu registro.
        </p>
