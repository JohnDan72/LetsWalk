<body>
    ...
    <div class="slider">
        ...
        <div class=" d-flex justify-content-center" data-entrance="from-right">
            <a href="<?= base_url() ?>AdoptaController" class="btn btn-color text-white d-none d-sm-block d-md-block d-lg-block d-md-xl-block">¡Adopta!</a>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 " data-entrance="from-left" data-entrance-delay="100">
                <div class="card border-light my-2 zoom">
                    <div class="card-body ">
                        ...
                        <a href="<?= base_url(); ?>RegistroController">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 " data-entrance="from-left" data-entrance-delay="200">
                ...
                <div class="card border-light my-2 zoom">
                    <div class="card-body">
                        <img src="<?= base_url() ?>private/media/icons/password.svg" width="128px" height="128px" class="card-img-top mt-4" alt="">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mx-auto d-block" data-entrance="from-left" data-entrance-delay="300">
    ...
    <?php
    if ($this->session->userdata('user')['scoreTest'] != null) {

    ?>
        <div class="slider_banner_1 my-5 align-items-center d-flex justify-content-center container" data-entrance="fade" data-entrance-delay="100">
            <div class="container">
                <h4 class="display-4  text-center text-white pt-5 ">
                    <i>Cuando te permites lo que mereces</i>
                </h4>

                <p class="display-4 text-center text-white mt-2" data-entrance="fade" data-entrance-delay="200" style="font-size: 20px">
                    <i>atraes lo que necesitas</i>
                </p>
    ...
    <div class="container mb-5">
        ...
        <div class=" d-flex justify-content-center mt-3 mb-5" data-entrance="fade" data-entrance-delay="300">
            <a href="<?= base_url(); ?>NosotrosController" class="btn btn-success text-white ">Conoce más</a>
        </div>
    </div>