...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>private/css/generarCita/index.css">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class=" d-flex justify-content-center">
            <img src="<?= base_url() ?>private/media/icons/enviar-mensaje.svg" alt="" width="200px" class="mt-5">
        </div>

        <h2 class="display-4 text-center mt-4">¡Genial!</h2>
        <h4 class="text-center mt-3">Un correo muy especial esta en camino</h4>
        <p class="text-center mt-5">En estos momentos estaras recibiendo un correo electronico con un archivo pdf, el cual
            utilizarás como comprobante.
        </p>
        <p class="mb-5 text-center">La información completa se encuentra ahí.</p>
