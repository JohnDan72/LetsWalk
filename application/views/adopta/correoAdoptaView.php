        ...
        <tr>
            <td align="center" valign="top" bgcolor="#ffffff" width="100%">
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                        <td background="https://image.ibb.co/i20fQ0/pexels-photo-460823.jpg" bgcolor="#0d0102" valign="top" style="background: url(https://image.ibb.co/i20fQ0/pexels-photo-460823.jpg) no-repeat center; background-color: #0d0102; background-position: center;">
                            <!--[if gte mso 9]>
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td style="text-align: center;">
                                                        <h3>Este mensaje es especial</h3>
                                                        <br>
                                                    </td>
                                                </tr>
                                            </table>
                                                ...
                                                <table style="margin: 0 auto;" cellspacing="0" cellpadding="8" width="180">
                                                    <tr>
                                                        ...
                                                        <td style="width:150px; height:33px; background-color: #212121;">
                                                            <div>
                                                                <a href=<?php echo $link?> style="background-color:#212121;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Comprobante de Cita</a>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="mobile-block mobile-padding" style="text-align:justify;">
                                                                    ...
                                                                    <br><br> Por favor sigue las siguientes intrucciones<br>
                                                                        ...
                                                                        2. Imprimelo. <br>
                                                                        3. El día de tu cita ¡NO OLVIDES LLEVARLO! o de lo contrario la beneficiencia a la que hayas asistido no podra ofrecerte el servicio. <br>
                                                                        4. Ya lo sabes pero te lo recordamos. ¡Tienes todo nuestro respeto! <br>
