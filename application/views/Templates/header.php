            ...
            <ul class="navbar-nav ">
                ...
                <li class="nav-item  dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="dd_menu">
                        ...
                        ?>
                                <a class="dropdown-item text-white" href="<?= base_url() ?>PanelControl/PUserController">Panel de Control</a>
                            <?php
                            } elseif ($this->session->userdata('user')['Tipo_User'] == 2) {
                            ?>
                                <a class="dropdown-item text-white" href="<?= base_url() ?>PanelControl/PBenefController">Panel de Control</a>
                            <?php
                            } elseif ($this->session->userdata('user')['Tipo_User'] == 3) {
                            ?>
                                <a class="dropdown-item text-white" href="<?= base_url() ?>PanelControl/PAdminController">Panel de Control</a>
                            <?php
                            }
                            ?>
